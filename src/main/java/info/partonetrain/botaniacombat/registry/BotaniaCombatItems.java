...
public final class BotaniaCombatItems {
    ...
    public static final Item.Properties ITEM_PROPERTIES_RARE = ITEM_PROPERTIES.fireResistant().rarity(Rarity.UNCOMMON);
    public static final Item.Properties ITEM_PROPERTIES_EPIC = ITEM_PROPERTIES.fireResistant().rarity(Rarity.EPIC);
