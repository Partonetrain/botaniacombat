...
public class BotaniaCombatShieldItems {
    ...
    public static final ManasteelShieldItem MANASTEEL_SHIELD = register("manasteel_shield", new ManasteelShieldItem(ITEM_PROPERTIES, SHIELD_COOLDOWN_TICKS, BotaniaCombatTiers.MANASTEEL_TIER));
    public static final ElementiumBannerShieldItem ELEMENTIUM_BANNER_SHIELD = register("elementium_banner_shield", new ElementiumBannerShieldItem(ITEM_PROPERTIES, SHIELD_COOLDOWN_TICKS, BotaniaCombatTiers.ELEMENTIUM_TIER));
    public static final TerrasteelShieldItem TERRASTEEL_SHIELD = register("terrasteel_shield", new TerrasteelShieldItem(ITEM_PROPERTIES, SHIELD_COOLDOWN_TICKS, BotaniaCombatTiers.TERRASTEEL_TIER));
