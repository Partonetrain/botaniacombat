...
public class ColorHandler {
    ...
    public static void submitBotaniaCombatItems(ItemHandlerConsumer items) {
        items.register((s, t) -> t == 0 ? Mth.hsvToRgb(ClientTickHandler.ticksInGame * 2 % 360 / 360F,  0.5F, 1F) : -1, BotaniaCombatItems.GAIA_GREATSWORD);
        items.register((s, t) -> t == 1 ? Mth.hsvToRgb(0.75F, 1F, 1.5F - (float) Math.min(1F, Math.sin(Util.getMillis() / 100D) * 0.5 + 1.2F)) : -1, BotaniaCombatItems.SOULSTAFF);
    }
}
