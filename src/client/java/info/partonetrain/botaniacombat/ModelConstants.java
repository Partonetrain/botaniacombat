...
public class ModelConstants {
    public static final ResourceLocation SOULSTAFF_MODEL = new ResourceLocation(BotaniaCombat.MOD_ID, "item/soulstaff");
    public static final ResourceLocation SOULSTAFF_MODEL_HELD = new ResourceLocation(BotaniaCombat.MOD_ID, "item/soulstaff_held");
    public static final ResourceLocation ELEMENTIUM_SPEAR_MODEL = new ResourceLocation(BotaniaCombat.MOD_ID, "item/elementium_spear");
    public static final ResourceLocation ELEMENTIUM_SPEAR_MODEL_HELD = new ResourceLocation(BotaniaCombat.MOD_ID, "item/elementium_spear_held");
